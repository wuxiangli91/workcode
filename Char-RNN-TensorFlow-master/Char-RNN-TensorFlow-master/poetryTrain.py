...
tf.flags.DEFINE_integer('num_seqs', 50, 'number of seqs in one batch')
tf.flags.DEFINE_integer('num_steps', 32, 'length of one seq')
...
tf.flags.DEFINE_string('input_file', r'D:/data/poetry.txt', 'utf8 encoded text file')
tf.flags.DEFINE_integer('max_steps', 20000, 'max steps to train')
tf.flags.DEFINE_integer('save_every_n', 1000, 'save the model every n steps')
tf.flags.DEFINE_integer('log_every_n', 10, 'log to the screen every n steps')
tf.flags.DEFINE_integer('max_vocab', 20000, 'max char number')
