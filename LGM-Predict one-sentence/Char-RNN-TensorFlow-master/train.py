...
max_steps=20000
'''
tf.flags.DEFINE_string('name', 'santi', 'name of the model')
tf.flags.DEFINE_integer('num_seqs', 64, 'number of seqs in one batch')
tf.flags.DEFINE_integer('num_steps', 36, 'length of one seq')
...
tf.flags.DEFINE_string('input_file', r'D:/data/santi1.txt', 'utf8 encoded text file')
tf.flags.DEFINE_integer('max_steps', 30000, 'max steps to train')
